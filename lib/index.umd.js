(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('expr-eval'), require('romans'), require('written-number'), require('@stdlib/utils-flatten-object')) :
	typeof define === 'function' && define.amd ? define(['exports', 'expr-eval', 'romans', 'written-number', '@stdlib/utils-flatten-object'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["marked-variables"] = {}, global.exprEval, global.romans, global.writtenNumber, global.flattenObject));
})(this, (function (exports, exprEval, romans, writtenNumber, flattenObject) { 'use strict';
	...
	function clearMarkedVariablesQueue() {
		varsQueue = [];
	...
	async function setMarkedVariable(name, content, page=0) {
		if(page < 0) return;
	...
	exports.clearMarkedVariablesQueue = clearMarkedVariablesQueue;
